fn main() {
    ...
    let w3 = w1 + &w2;
    println!();
    println!("{} is aimed at developing competent, creatice, innovative, entrepreneurial and ethically minded persons, capable of creating value in the diverse fields of computer science", w3);
}
